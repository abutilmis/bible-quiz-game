...
const questions: Question[] = [
  {
    id: 1,
    text: "በማቴዎስ ወንጌል ምዕራፍ 17 መሠረት፥ ጴጥሮስ ካጠመደው መጀመሪያ ዓሣ አፍ ውስጥ የተገኘው ምን ነበር?",
    options: ["የወርቅ ሳንቲም", "ስታቴር", "ብር", "ዕንቁ"],
    correctAnswer: 1
  },
  {
    id: 2,
    text: "በሉቃስ ወንጌል ምዕራፍ 1 መሠረት፥ ካህኑ ዘካርያስ የመልአኩን የምሥራች ስላላመነ ሕፃኑ እስኪወለድ ምን ሆነ?",
    options: ["ዕውር ሆነ", "ዱዳ ሆነ", "ሽባ ሆነ", "ለምጻም ሆነ"],
    correctAnswer: 1
  },
  {
    id: 3,
    text: "በዮሐንስ ወንጌል ምዕራፍ 9 መሠረት፥ ኢየሱስ ክርስቶስ ዕውሩን ሰው ዓይኑን ቀብቶ እንዲታጠብ የላከው ወዴት ነበር?",
    options: ["ወደ ቤተ ሳይዳ መጠመቂያ", "ወደ ሰሎሞን መጠመቂያ", "ወደ ሰሊሆም መጠመቂያ", "ወደ ዮርዳኖስ ወንዝ"],
    correctAnswer: 2
  },
  {
    id: 4,
    text: "በሐዋርያት ሥራ ምዕራፍ 12 መሠረት፥ ጴጥሮስን በሌሊት ከሄሮድስ ወኅኒ ቤት በድንቅ የመራውና ያወጣው ማን ነበር?",
    options: ["የእግዚአብሔር መልአክ", "ወንጌላዊው ማርቆስ", "የወኅኒው ጠባቂ", "ሐዋርያው ዮሐንስ"],
    correctAnswer: 0
  },
  {
    id: 5,
    text: "በሐዋርያት ሥራ ምዕራፍ 16 መሠረት፥ ጳውሎስና ሲላስ በፊልጵስዩስ ወኅኒ ቤት እኩለ ሌሊት ላይ ምን ያደርጉ ነበር?",
    options: ["ያለቅሱ ነበር", "ይጸልዩና እግዚአብሔርን በዜማ ያመሰግኑ ነበር", "የሚያመልጡበትን መንገድ እያሰቡ ነበር", "ዝም ብለው ይተኙ ነበር"],
    correctAnswer: 1
  },
  {
    id: 6,
    text: "በሮሜ መልእክት ምዕራፍ 16 መሠረት፥ ጳውሎስ የነገረውን ይህንን ታላቅ መልእክት በብዕር የጻፈው ጸሐፊ ማን ነበር?",
    options: ["ጢሞቴዎስ", "ሉቃስ", "ጤርጥዮስ", "አቂላ"],
    correctAnswer: 2
  },
  {
    id: 7,
    text: "በ፩ኛ ቆሮንቶስ ምዕራፍ 15 መሠረት፥ ክርስቶስ ከትንሣኤው በኋላ በአንድ ጊዜ ከስንት ለሚበልጡ ወንድሞች ታየ?",
    options: ["ከአሥራ ሁለት ወንድሞች", "ከሰባ ወንድሞች", "ከአምስት መቶ ለሚበልጡ ወንድሞች", "ከአሥራ ሁለት ሺህ ወንድሞች"],
    correctAnswer: 2
  },
  {
    id: 8,
    text: "በገላትያ መልእክት ምዕራፍ 2 መሠረት፥ ጳውሎስ የትኛውን ሐዋርያ ነበር በአንጾኪያ ፊት ለፊት የተቃወመው?",
    options: ["በበርናባስ ላይ", "በኬፋ (በጴጥሮስ) ላይ", "በያዕቆብ ላይ", "በዮሐንስ ላይ"],
    correctAnswer: 1
  },
  {
    id: 9,
    text: "በያዕቆብ መልእክት ምዕራፍ 2 መሠረት፥ ያለ ሥራ የሞተ እንደሆነ የተገለጠውና አጋንንት እንኳ አምነው የሚንቀጠቀጡበት ምንድነው?",
    options: ["እምነት", "ፍቅር", "ተስፋ", "እውቀት"],
    correctAnswer: 0
  },
  {
    id: 10,
    text: "በዮሐንስ ራዕይ ምዕራፍ 3 መሠረት፥ “ለብ ስላልህ፥ በራድም ወይም ትኩስ ስላልሆንህ ከአፌ ልተፋህ ነው” የተባለችው ቤተ ክርስቲያን ማን ናት?",
    options: ["የሰምርኔስ ቤተ ክርስቲያን", "የሰርዴስ ቤተ ክርስቲያን", "የሎዶቅያ ቤተ ክርስቲያን", "የፊላደልፊያ ቤተ ክርስቲያን"],
    correctAnswer: 2
  }
];
      ...
      >
        <div className="bg-white/10 backdrop-blur rounded-2xl p-8 max-w-md w-full text-center border border-[#FFD966]/30 shadow-2xl">
          ...
          <div className="text-white/80 space-y-3 text-left mb-6">
            <p>✨ በዛሬው ውድድር <strong className="text-[#FFD966]">{10} የአዲስ ኪዳን የመጽሃፍ ቅዱስ ጥያቄዎች</strong> ይኖሩናል።</p>
