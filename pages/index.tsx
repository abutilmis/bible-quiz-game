...
const questions: Question[] = [
  {
    id: 1,
    text: "ሙሴ ከግብፅ ወጥቶ በምድያም ምድር በስደት በኖረበት ጊዜ ያገባት የካህኑ የዮቶር ልጅ ማን ትባላለች?",
    options: ["አስማት", "ሲፓራ", "ርብቃ", "ፌቤን"],
    correctAnswer: 1
  },
  {
    id: 2,
    text: "ሶስት መቶ ቀበሮዎችን በመያዝ፣ ጭራና ጭራቸውን አሳስሮ በችቦ እሳት የፍልስጤማውያንን የእህል ማደሪያ ያቃጠለው ማን ነው?",
    options: ["ጌድዮን", "ሳምሶን", "ሳኦል", "ዮናታን"],
    correctAnswer: 1
  },
  {
    id: 3,
    text: "ዳዊት የጎልያድን ራስ ከቆረጠ በኋላ፣ የሳኦል ልጅ ዮናታን ከዳዊት ጋር የነበረው ወዳጅነት ምን ይመስል ነበር?",
    options: ["በቅናት ተሞልቶ ነበር", "እንደ ነፍሱ ወደደው፣ ኪዳንም አደረገ", "ከንጉሱ አባት ጋር ሆኖ ሊገድለው አሴረ", "ከሀገር እንዲሰደድ አደረገው"],
    correctAnswer: 1
  },
  {
    id: 4,
    text: "በኢየሱስ ክርስቶስ ስቅለት ወቅት፣ በርባን የተባለውን ወንበዴ እንዲፈታላቸውና ኢየሱስ እንዲሰቀል አጥብቀው የጮኹት ወገኖች በማን እየተመሩ ነበር?",
    options: ["በሮም ወታደሮች", "በፈሪሳውያንና በካህናት አለቆች", "በሰማርያ ሰዎች", "በሴንቱሪዮኑ (በመቶ አለቃው)"],
    correctAnswer: 1
  },
  {
    id: 5,
    text: "እግዚአብሔር ለኖኅ የሰጠውና ምድርን ዳግመኛ በውኃ ጥፋት እንዳያጠፋት የገባው የኪዳን ምልክት ምንድን ነው?",
    options: ["ቀስተ ደመና", "የመሠዊያ እሳት", "የወይራ ቅጠል", "የግርዛት ሥርዓት"],
    correctAnswer: 0
  },
  {
    id: 6,
    text: "በጌታ ቀን በራዕይ ታላቅ ድምፅ የሰማውና የዮሐንስ ራዕይ መጽሐፍን የጻፈው ሐዋርያው ዮሐንስ የት ደሴት ላይ ተግዞ ሳለ ነበር?",
    options: ["በቀርጤስ ደሴት", "በማልታ ደሴት", "በፍጥሞ ደሴት", "በቆጵሮስ ደሴት"],
    correctAnswer: 2
  },
  {
    id: 7,
    text: "ንጉሥ ሰሎሞን የእግዚአብሔርን ቤተ መቅደስ ለመሥራት ስንት ዓመት ፈጀበት?",
    options: ["3 ዓመት", "7 ዓመት", "12 ዓመት", "40 ዓመት"],
    correctAnswer: 1
  },
  {
    id: 8,
    text: "ኢየሱስ ክርስቶስ አልዓዛርን ከመቃብር ከማስነሳቱ በፊት፣ አልዓዛር ከሞተ ስንት ቀን ሆኖት ነበር?",
    options: ["2 ቀን", "3 ቀን", "4 ቀን", "7 ቀን"],
    correctAnswer: 2
  },
  {
    id: 9,
    text: "ከእስራኤል ነገሥታት ሁሉ እጅግ ክፉ የነበረውና የሲዶናውያንን ንጉሥ ልጅ ኤልዛቤልን አግብቶ በአምልኮተ ባዓል የጸናው ንጉሥ ማን ይባላል?",
    options: ["አክዓብ", "ኢዮርብዓም", "ምናሴ", "ሮብዓም"],
    correctAnswer: 0
  },
  {
    id: 10,
    text: "በሐዋርያት ሥራ መጽሐፍ መሠረት፣ የመጀመርያው ክርስቲያን ስለ እምነቱ በድንጋይ ተወግሮ የሞተው ሰማዕት ማን ነው?",
    options: ["ፊልጶስ", "እስጢፋኖስ", "ጢሞቴዎስ", "በርናባስ"],
    correctAnswer: 1
  }
];
