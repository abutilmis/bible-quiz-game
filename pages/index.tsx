...
const questions: Question[] = [
  {
    id: 1,
    text: "እኔ ክፉ እና በቀለኛ ንግሥት ነበርኩ፣ ፍጻሜዬም አሳዛኝ ነበር። እኔ ማን ነኝ?",
    options: ["ኤልዛቤል", "የሳባ ንግሥት", "አስቴር", "አስጢን"],
    correctAnswer: 0
  },
  {
    id: 2,
    text: "እኔ ቆንጆ እና ማራኪ ነበርኩ፣ ነገር ግን ለማግባት 14 ዓመታት ለመጠበቅ ተገድጃለሁ። እኔ ማን ነኝ?",
    options: ["ልያ", "ራሔል", "ደሊላ", "ሰሎሜ"],
    correctAnswer: 1
  },
  {
    id: 3,
    text: "እኔ 3 በ1 (ሦስት አንድነት) ነኝ፣ ከመጀመሪያውም ጀምሮ ነበርኩ። እኔ ማን ነኝ?",
    options: ["ተፈጥሮ", "ሥላሴ", "የመላእክት ሠራዊት", "ጊዜ"],
    correctAnswer: 1
  },
  {
    id: 4,
    text: "በሰቆቃው መጽሐፍ ምክንያት “አልቃሻው ነቢይ” ተብዬ በሰፊው እታወቃለሁ። እኔ ማን ነኝ?",
    options: ["ዮናስ", "ኢሳይያስ", "ኤርምያስ", "ኢዩኤል"],
    correctAnswer: 2
  },
  {
    id: 5,
    text: "እኔ ትልቅ ቤተሰብ አለኝ፣ “የእምነት አባት” ተብዬም እታወቃለሁ። እኔ ማን ነኝ?",
    options: ["ያዕቆብ", "እስራኤል", "አብርሃም", "ዳዊት"],
    correctAnswer: 2
  },
  {
    id: 6,
    text: "እኔ ቀናተኛ/የማልመች ሰው ነኝ፤ ስወለድም የወንድሜን ተረከዝ ይዤ ነበር። እኔ ማን ነኝ?",
    options: ["አቤል", "ቃየን", "ዔሳው", "ያዕቆብ"],
    correctAnswer: 3
  },
  {
    id: 7,
    text: "እኔ ነቢይ ነኝ፣ ሰዎችም በራሰ በራነቴ አፌዙብኝ። እኔ ማን ነኝ?",
    options: ["ኤልሳዕ", "ኤልያስ", "መጥምቁ ዮሐንስ", "አምሶን"],
    correctAnswer: 0
  },
  {
    id: 8,
    text: "ይሁዳ አስቆሮቱን ለመተካት በሐዋርያት የተመረጥኩት እኔ ነኝ። እኔ ማን ነኝ?",
    options: ["ጳውሎስ", "ጴጥሮስ", "ማትያስ", "ጢሞቴዎስ"],
    correctAnswer: 2
  },
  {
    id: 9,
    text: "በጣም ተርቤ ስለነበር ብኩርናዬን በምስር ወጥ ለወጥኩ። እኔ ማን ነኝ?",
    options: ["አብርሃም", "ሳኦል", "ያዕቆብ", "ዔሳው"],
    correctAnswer: 3
  },
  {
    id: 10,
    text: "“የአይሁድ ንጉሥ” ሲወለድ፣ በሁሉም መንገድ ልገድለው ሞከርኩ። እኔ ማን ነኝ?",
    options: ["አክዓብ", "ሄሮድስ", "ናቡከደነጾር", "ቂሮስ"],
    correctAnswer: 1
  }
];
      ...
      >
        <div className="bg-white/10 backdrop-blur rounded-2xl p-8 max-w-md w-full text-center border border-[#FFD966]/30 shadow-2xl">
          ...
          <div className="text-white/80 space-y-3 text-left mb-6">
            <p>✨ በዛሬው ውድድር <strong className="text-[#FFD966]">{10}የእኔ ማነኝ ጥያቄዎች</strong> ይኖሩናል።</p>
