...
const questions: Question[] = [
  {
    id: 1,
    book: "ዘጸአት",
    question: "ከያዕቆብ ጋር ወደ ግብፅ የመጡት የቤተሰቡ አባላት ብዛት ስንት ነበር?",
    options: ["አርባ", "ስልሳ", "ሰባ", "መቶ"],
    correctIndex: 2,
    explanation: "በዘጸአት 1:5 መሠረት ከያዕቆብ ወገብ የወጡት ነፍሳት ሁሉ ሰባ ነበሩ።"
  },
  {
    id: 2,
    book: "ዘጸአት",
    question: "ዮሴፍን የማያውቀው አዲሱ የግብፅ ንጉሥ፣ የእስራኤል ልጆች ቁጥር እየበዛ በመሄዱ የፈራበት ምክንያት ምንድን ነው?",
    options: [
      "ጦርነት ቢነሳ ከጠላቶቻቸው ጋር ይወግናሉ ብሎ",
      "መሬታችንን ይወርሳሉ ብሎ",
      "ንግዱን ይቆጣጠራሉ ብሎ",
      "ግብፃውያንን ባሪያ ያደርጋሉ ብሎ"
    ],
    correctIndex: 0,
    explanation: "በዘጸአት 1:10 መሠረት ሰልፍ በሆነ ጊዜ ጠላቶቻችንን ተጨምረው እንዳይወጉንና ከምድር እንዳይወጡ በመስጋት ነበር።"
  },
  {
    id: 3,
    book: "ዘጸአት",
  ...
  },
  {
    id: 4,
    book: "ዘጸአት",
    question: "ሕፃኑን ሙሴን በዓባይ ወንዝ ዳርቻ ካለው ሸምበቆ መካከል ባለው ዘንቢል ውስጥ ያገኘው ማን ነው?",
    options: ["የፈርዖን ሚስት", "የፈርዖን እህት", "የፈርዖን ልጅ", "አንድ አገልጋይ ሴት"],
    correctIndex: 2,
    explanation: "በዘጸአት 2:5-6 መሠረት የፈርዖን ልጅ ለመታጠብ ወደ ወንዝ በወረደች ጊዜ ሳጥኑን አየች።"
  },
  {
    id: 5,
    book: "ዘጸአት",
    question: "ሙሴ ከግብፅ ሸሽቶ ወደ ምድያም ሀገር የሄደው ለምንድን ነው?",
    options: [
      "ከንጉሡ ቤተሰብ ጋር ስለተጣላ",
      "ንጉሡን ለመውጋት ሠራዊት ለመሰብሰብ",
      "ዕብራዊውን ሲመታ የነበረውን ግብፃዊ ስለገደለ",
      "እረኛ ሆኖ ለመኖር ስለፈለገ"
    ],
    correctIndex: 2,
    explanation: "በዘጸአት 2:11-15 መሠረት ሙሴ ግብፃዊውን መግደሉ ስለታወቀና ፈርዖን ሊገድለው ስለፈለገ ወደ ምድያም ሸሸ።"
  },
  {
    id: 6,
    book: "ዘጸአት",
    question: "ሙሴ እግዚአብሔር በሚነድ ቍጥቋጦ ውስጥ ሆኖ ሲያናግረው በየትኛው ተራራ ላይ ነበር?",
    options: ["በሲና ተራራ", "በኮሬብ ተራራ", "በአራራት ተራራ", "በናባው ተራራ"],
    correctIndex: 1,
    explanation: "በዘጸአት 3:1-2 መሠረት ሙሴ መንጋውን ወደ እግዚአብሔር ተራራ ወደ ኮሬብ ነዳ።"
  },
  {
    id: 7,
    book: "ዘጸአት",
    question: "እግዚአብሔር ለሙሴ ተገልጦ የስሙን ትርጉም በምን ተናገረ?",
    options: [
      "“ያለና የሚኖር እኔ ነኝ”",
      "“የአብርሃም አምላክ ነኝ”",
      "“የሠራዊት ጌታ እግዚአብሔር ነኝ”",
    ...
    correctIndex: 0,
    explanation: "በዘጸአት 3:14 መሠረት እግዚአብሔርም ሙሴን፦ «ያለና የሚኖር እኔ ነኝ» አለው።"
  },
  {
    id: 8,
    book: "ዘጸአት",
    question: "እግዚአብሔር ለሙሴ፣ እስራኤላውያን እሱን እንደላከው እንዲያምኑ የሰጠው ሦስተኛው ምልክት ምንድን ነው?",
    options: [
      "በትር ወደ እባብ መለወጥ",
      "እጁ በለምጽ መመታት",
      "ከወንዙ ውሃ ቀድቶ በደረቅ መሬት ላይ ሲያፈሰው ደም መሆኑ",
      "የዓባይ ወንዝ መከፈል"
    ],
    correctIndex: 2,
    explanation: "በዘጸአት 4:9 መሠረት የመጀመሪያዎቹን ሁለቱን ተአምራት ካላመኑ ከወንዙ ውኃ ቀድቶ በደረቅ መሬት ላይ እንዲያፈስና ደም እንደሚሆን ነገረው።"
  },
  {
    id: 9,
    book: "ዘጸአት",
    question: "ሙሴና አሮን ፈርዖንን “ሕዝቤን ልቀቅ” ብለው በጠየቁ ጊዜ፣ ፈርዖን እምቢ ላለበት ምክንያት የሰጠው መልስ ምንድን ነው?",
    options: [
      "“እግዚአብሔርን አላውቅም”",
      "“የግብፅ አማልክት ከእርሱ ይበረታሉ”",
      "“የሕዝቡ ቁጥር እጅግ በዝቷል”",
      "“እነዚህ ሕዝቦች የእኔ ባሪያዎች ናቸው”"
    ],
    correctIndex: 0,
    explanation: "በዘጸአት 5:2 መሠረት ፈርዖንም፦ «ቃሉን እሰማው ዘንድ እስራኤልንስ እለቀው ዘንድ እግዚአብሔር ማን ነው? እግዚአብሔርን አላውቅም» አለ።"
  },
  {
    id: 10,
    book: "ዘጸአት",
    question: "ሙሴና አሮን ፈርዖንን ካናገሩ በኋላ፣ ፈርዖን የእስራኤላውያንን የጉልበት ሥራ ለማክበድ ምን እንዳይሰጣቸው ትዕዛዝ አስተላለፈ?",
    options: ["ውሃ", "ጭድ", "ምግብ", "መሣሪያዎች"],
    correctIndex: 1,
    explanation: "በዘጸአት 5:7 መሠረት ፈርዖን ጡብ ለመሥራት ጭድ እንዳይሰጣቸው፣ ራሳቸው ሄደው እንዲለቅሙ አዘዘ።"
  }
];
...
export default function Home() {
  ...
  // yet — must NOT touch quizStartTime, since saveResult() still needs it to
  // compute duration. Only the full clearProgress() (after duration is read)
