...
const questions: Question[] = [
  {
    id: 1,
    text: "በኦሪት ዘፍጥረት ምዕራፍ 36 መሠረት፥ ዔሳው በከነዓን ምድር ሚስቶችን አግብቶ ዘሩ ከበረከተ በኋላ፥ ከወንድሙ ከያዕቆብ ፊት ርቆ ሄዶ የሰፈረበት ተራራማ አገር ማን ይባላል?",
    options: ["የኮሬብ ተራራ", "የሰዓር ተራራ", "የአራራት ተራራ", "የናባው ተራራ"],
    correctAnswer: 1
  },
  {
    id: 2,
    text: "በኦሪት ዘጸአት ምዕራፍ 31 መሠረት፥ እግዚአብሔር የመገናኛውን ድንኳን ዕቃዎችና ታቦቱን በጥበብና በማስተዋል ይሠሩ ዘንድ ከይሁዳ ነገድ በስም የጠራው ዋናው ብልህ ባለሙያ ማን ነበር?",
    options: ["በሰልኤል", "አልያብ", "ኪራም", "ዘሩባቤል"],
    correctAnswer: 0
  },
  {
    id: 3,
    text: "በኦሪት ዘኍልቁ ምዕራፍ 16 መሠረት፥ በሙሴና በአሮን ክህነት ላይ በማመፃቸው ምክንያት ምድር አፏን ከፍታ  በሕይወታቸው የዋጠቻቸው እነማን ነበሩ?",
    options: ["ናዳብና አብዩድ", "ቆሬ፥ ዳታንና አቤሮን", "ሲሶራና በለዓም", "ሴሜኢና አኪጦፌል"],
    correctAnswer: 1
  },
  {
    id: 4,
    text: "በ፩ኛ ሳሙኤል ምዕራፍ 4 መሠረት፥ የእግዚአብሔር ታቦት መማረኳን ሰምቶ ከወንበሩ ላይ ወደ ኋላው ወድቆ የሞተው ካህን ማን ነው?",
    options: ["ፊንሐስ", "ኤሊ", "አኪያ", "አኪጦብ"],
    correctAnswer: 1
  },
  {
    id: 5,
    text: "በ፩ኛ ነገሥት ምዕራፍ 14 መሠረት፥ የንጉሥ ኢዮርብዓም ልጅ ታሞ በነበረ ጊዜ፥ ሚስቱ ማንነቷን ለውጣ እንድትጠይቀው የተላከችውና በሴሎ ይኖር የነበረው ዕውሩ ነቢይ ማን ይባላል?",
    options: ["አኪያ", "ናታን", "ሚክያስ", "አሞጽ"],
    correctAnswer: 0
  },
  {
    id: 6,
    text: "የእስራኤል ልጆች በከነዓን ንጉሥ በኢያቢስ በተጨነቁ ጊዜ እስራኤልን ትመራ የነበረችው ነቢይት ማን ናት?",
    options: ["ሐና", "ዲቦራ", "ዮካብድ", "አቢግያ"],
    correctAnswer: 1
  },
  {
    id: 7,
    text: "በማቴዎስ ወንጌል ምዕራፍ 27 መሠረት፥ ይሁዳ የአስቆሮቱ የጌታን ደም አሳልፎ የሰጠበትን ሰላሳ ብር በቤተ መቅደስ ጥሎ ከሞተ በኋላ፥ ካህናቱ መጻተኞች እንዲቀበሩበት የገዙበት “የሸክላ ሠሪው እርሻ” ምን ተብሎ ተጠራ?",
    options: ["ጌቴሴማኒ", "አኬልዳማ", "ጎልጎታ", "ጋዛ"],
    correctAnswer: 1
  },
  {
    id: 8,
    text: " በሰማርያ ከተማ ጥንቆላ ሥራው ሕዝቡን ሲያስገርም የነበረና በኋላ ግን አምኖ ከተጠመቀ በኋላ የመንፈስ ቅዱስን ስጦታ በገንዘብ ለመግዛት በመሞከሩ በጴጥሮስ የተገሰጸው ሰው ማን ነው?",
    options: ["ሲሞን ", "ኤልማስ", "ፊሊክስ", "ጋልዮስ"],
    correctAnswer: 0
  },
  {
    id: 9,
    text: "በሐዋርያት ሥራ ምዕራፍ 5 መሠረት፥ መሬታቸውን ሽጠው ከዋጋው ያስቀሩትና ሐዋርያው ጴጥሮስንና መንፈስ ቅዱስን በመዋሸታቸው ምክንያት ወድቀው የሞቱት ባልና ሚስት እነማን ናቸው?",
    options: ["አቂላና ጵርስቅላ", "ሐናንያና ሰጲራ", "ፊሊክስና ድሩሲላ", "ሐናንያናና ጵርስቅላ"],
    correctAnswer: 1
  },
  {
    id: 10,
    text: "በዮሐንስ ራዕይ ምዕራፍ 2 መሠረት፥ ለኤፌሶን ቤተ ክርስቲያን መልአክ በተጻፈው መልእክት ላይ፥ ጌታ የጠላውና በቤተ ክርስቲያኑ ውስጥ የነበረው የክፉ ትምህርት አራማጆች ወገን ምን ተብሎ ተጠርቷል?",
    options: ["የኒቆላውያን ወገን", "የሰማርያውያን ወገን", "የሰዱቃውያን ወገን", "የኤፊቆሮሳውያን ወገን"],
    correctAnswer: 0
  }
];
