...
const questions: Question[] = [
  {
    id: 1,
    text: "በዘፍጥረት 1:2 መሠረት፣ ምድርም ባዶ ነበረች፥ አንዳችም አልነበረባትም፤ ጨለማም በጥልቁ ላይ ነበረ፤ ምንስ በውኃ ላይ ይሰፍፍ (ይረብብ) ነበር?",
    options: ["የእግዚአብሔር መንፈስ", "ታላቅ ብርሃን", "የንፋስ ኃይል", "የኪሩቤል ክንፍ"],
    correctAnswer: 0
  },
  {
    id: 2,
    text: "በዘፍጥረት 3:24 መሠረት፣ እግዚአብሔር አዳምን ካስወጣው በኋላ፥ ወደ ሕይወት ዛፍ የሚወስደውን መንገድ ለመጠበቅ በዔድን ገነት ምሥራቅ ያስቀመጠው መልአክ ማን ነበር?",
    options: ["ሱራፌል", "ኪሩቤል", "ሊቃነ መላእክት", "ኃይላት"],
    correctAnswer: 1
  },
  {
    id: 3,
    text: "የአቤልና የቃየን ሥራዎች በቅደም ተከተል ምንና ምን ነበሩ?",
    options: ["አቤል ምድርን የሚያርስ ነበረ፥ ቃየን ግን በግ ጠባቂ ነበረ", "አቤል በግ ጠባቂ ነበረ፥ ቃየን ግን ምድርን የሚያርስ ነበረ", "አቤል አንጥረኛ ነበረ፥ ቃየን ግን ድንኳን ሰፊ ነበረ", "አቤል ዘፋኝ ነበረ፥ ቃየን ግን አዳኝ ነበረ"],
    correctAnswer: 1
  },
  {
    id: 4,
    text: "እግዚአብሔር ኖኅን ከየትኛው የ እንጨት አይነት ነበር  መርከብን እንዲሰራ ያዘዘው?",
    options: ["የዝግባ እንጨት", "የግራር እንጨት", "የጎፈር እንጨት", "የወይራ እንጨት"],
    correctAnswer: 2
  },
  {
    id: 5,
    text: "አብራም እግዚአብሔር እንደ ነገረው ለመሄድ  የወጣበት ስፍራ ምን ይባላል?",
    options: ["ከዑር", "ከካራን", "ከኬብሮን", "ከግብፅ"],
    correctAnswer: 1
  },
  {
    id: 6,
    text: "የአብራም ሚስት ሣራ  ማን የምትባል ግብፃዊት ባሪያ ነበረቻት?",
    options: ["ኬጡራ", "ሬቤካ", "ሐጋር", "ሊያ"],
    correctAnswer: 2
  },
  {
    id: 7,
    text: "ያዕቆብ ከአባቱ ከይስሐቅ በረከትን ለመውሰድ ወደ አባቱ ይዞት የገባውና እናቱ ርብቃ ያዘጋጀችው ምግብ ምን ነበረ?",
    options: ["የገብስ ቂጣና ወተት", "አባቱ እንደሚወደው የተሰራ ጣፋጭ መብል", "የምስር ወጥ", "የበለስ ፍሬ"],
    correctAnswer: 1
  },
  {
    id: 8,
    text: "ያዕቆብ በሕልሙ የእግዚአብሔር መላእክት ሲወጡባትና ሲወርዱባት የነበረችውን መሰላል ካየ በኋላ፥ ቀድሞ “ሉዛ” ትባል የነበረችውን የዚያችን ስፍራ ስም ማን ብሎ ጠራት?",
    options: ["ሴሎ", "ቤቴል", "ቤርሳቤ", "ጵኔል"],
    correctAnswer: 1
  },
  {
    id: 9,
    text: "ዮሴፍ በግዞት ቤት ሳለ ሕልማቸውን ከመፍታቱ በፊት፥ በግብፅ ንጉሥ ላይ በደል አድርገው በወኅኒ የተጣሉት ሁለት አለቆች እነማን ነበሩ?",
    options: ["የወታደሮቹ አለቃና የነጋዴዎቹ አለቃ", "የጠጅ አሳላፊ አለቃና የጋጋሪው አለቃ", "የቤተ መንግሥቱ ጠባቂና ጸሐፊው", "የፈርዖን አማካሪና መኳንንቱ"],
    correctAnswer: 1
  },
  {
    id: 10,
    text: "በዘፍጥረት 50:13 መሠረት፣ ያዕቆብ በሞተ ጊዜ ልጆቹ  አብርሃም ለመቃብር ርስት ከኬጢያዊው ከኤፍሮን እርሻ ጋር በገዛው በመምሬ ፊት ለፊት ባለችው በየትኛው ዋሻ ውስጥ ቀበሩት?",
    options: ["ባለ ሁለት ድርብ ዋሻ", "በኤዶም ዋሻ", "በሲና ዋሻ", "በዮርዳኖስ ዋሻ"],
    correctAnswer: 0
  }
];
      ...
      >
        <div className="bg-white/10 backdrop-blur rounded-2xl p-8 max-w-md w-full text-center border border-[#FFD966]/30 shadow-2xl">
          ...
          <div className="text-white/80 space-y-3 text-left mb-6">
            <p>✨ በዛሬው ውድድር <strong className="text-[#FFD966]">{10} የዘፍጥረት ጥያቄዎች</strong> ይኖሩናል።</p>
