...
const questions: Question[] = [
  {
    id: 1,
    text: "በሐዋርያት ሥራ ምዕራፍ 11 መሠረት፥ በርናባስ ሳውልን ፍለጋ የሄደው ወደ የትኛው ከተማ ነበር?",
    options: ["ወደ ጠርሴስ", "ወደ ደማስቆ", "ወደ አንጾኪያ", "ወደ ፊልጵስዩስ"],
    correctAnswer: 0
  },
  {
    id: 2,
    text: "በሐዋርያት ሥራ ምዕራፍ 13 መሠረት፥ ጳውሎስ በቆጵሮስ ደሴት ሳለ ዕውር ያደረገው ጠንቋይ ማን ይባላል?",
    options: ["ሲሞን", "ኤልማስ", "ፊሊክስ", "ጤርጥሎስ"],
    correctAnswer: 1
  },
  {
    id: 3,
    text: "ሐዋርያው ጳውሎስ የተወለደው በየትኛው ታዋቂ ከተማ ነበር?",
    options: ["በጠርሴስ", "በናዝሬት", "በቆሮንቶስ", "በኤፌሶን"],
    correctAnswer: 0
  },
  {
    id: 4,
    text: "በፊሊሞን መልእክት መሠረት፥ ጳውሎስ ወደ ጌታው የመለሰው ኮብላይ ባሪያ ማን ይባላል?",
    options: ["አናንያ", "አኔሲሞስ", "አርስጥሮኮስ", "ቲቶ"],
    correctAnswer: 1
  },
  {
    id: 5,
    text: "ጳውሎስ በኢየሩሳሌም ሳለ በማን እግር አጠገብ ተቀምጦ ነበር የአይሁድን ሕግ የተማረው?",
    options: ["በገማልያል", "በቀያፋ", "በኒቆዲሞስ", "በኤሊ"],
    correctAnswer: 0
  },
  {
    id: 6,
    text: "ሐዋርያው ጳውሎስ በዋናነት የማን ሐዋርያ ተብሎ ይታወቃል?",
    options: ["የአይሁድ ሐዋርያ", "የአሕዛብ ሐዋርያ", "የሰማርያ ሐዋርያ", "የነገሥታት ሐዋርያ"],
    correctAnswer: 1
  },
  {
    id: 7,
    text: "ከወንጌላት ቀጥሎ ባለው በአዲስ ኪዳን መጻሕፍት ውስጥ አብዛኛዎቹን መልእክታት የጻፈው ማን ነው?",
    options: ["ሐዋርያው ዮሐንስ", "ሐዋርያው ጴጥሮስ", "ሐዋርያው ጳውሎስ", "ያዕቆብ"],
    correctAnswer: 2
  },
  {
    id: 8,
    text: "ጳውሎስ ከአይሁድ ውጭ በደሙ የትኛው ሀገር ዜግነት ነበረው?",
    options: ["የሮሜ ዜግነት", "የግሪክ ዜግነት", "የግብፅ ዜግነት", "የፋርስ ዜግነት"],
    correctAnswer: 0
  },
  {
    id: 9,
    text: "ሐዋርያው ጳውሎስ  በፊት ክርስቲያኖችን ያሳድድ በነበረበት ጊዜ ስሙ ማን ነበር?",
    options: ["በርናባስ", "ሳውል", "ስጢፋኖስ", "ጢሞቴዎስ"],
    correctAnswer: 1
  },
  {
    id: 10,
    text: "ሳውል (ጳውሎስ) ወደ ክርስቶስ ያገነው ወደ የትኛው ከተማ በጉዞ ላይ ሳለ ነበር?",
    options: ["ወደ ሮሜ", "ወደ ኢየሩሳሌም", "ወደ ደማስቆ", "ወደ አንጾኪያ"],
    correctAnswer: 2
  }
];
