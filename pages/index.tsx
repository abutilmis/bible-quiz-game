...
const questions: Question[] = [
  ...
  {
    id: 1,
    text: "ነቢዩ ሳሙኤል ዳዊትን በዘይት ቀብቶ የንጉሥነት እጩ አድርጎ የመረጠው በየትኛው ከተማ ነበር?",
    options: ["በኢየሩሳሌም", "በቤተልሔም", "በኬብሮን", "በሴሎ"],
    correctAnswer: 1
  },
  {
    id: 2,
    text: "ከመዝሙራቱ መካከል የመጸጸትና የስርየት መዝሙር ተብሎ የሚታወቀው የትኛው መዝሙር ነው?",
    options: ["መዝሙር 23", "መዝሙር 51", "መዝሙር 91", "መዝሙር 119"],
    correctAnswer: 1
  },
  {
    id: 3,
    text: "ዳዊት በሳኦል ቤተ መንግሥት ገብቶ በገና ይጫወት የነበረው ለምን ነበር?",
    options: ["ንጉሡን ለማስደሰት", "ክፉ መንፈስ ሳኦልን ሲያጨንቀው እንዲለቀው", "ለጦርነት ማበረታቻ", "በቤተ መንግሥት ድግስ ላይ"],
    correctAnswer: 1
  },
  {
    id: 4,
    text: "ዳዊት ከጎልያድ ጋር ከመዋጋቱ በፊት መንጋውን ሲጠብቅ የገደላቸው ሁለቱ አራዊት እነማን ነበሩ?",
    options: ["ተኩላና ድብ", "አንበሳና ተኩላ", "አንበሳና ድብ", "ነብርና አንበሳ"],
    correctAnswer: 2
  },
  ...
  {
    id: 5,
    text: "ዳዊት ፍልስጥኤማዊውን ጎልያድን ለመውጋት ከወንዝ ያከማቻቸው ድንጋዮች ብዛት ስንት ነበር?",
    options: ["ሦስት", "አምስት", "ሰባት", "አሥር"],
    correctAnswer: 1
  },
  {
    id: 6,
    text: "ጎልያድ የትኛው ሀገር (ከተማ) ተወላጅ ፍልስጥኤማዊ ነበር?",
    options: ["የጌት", "የጋዛ", "የአሽዶድ", "የኢያሪኮ"],
    correctAnswer: 0
  },
  ...
  {
    id: 7,
    text: "ነፍሱ ከዳዊት ነፍስ ጋር የተጣበቀችውና እንደ ነፍሱ አድርጎ የወደደው የሳኦል ልጅ ማን ይባላል?",
    options: ["አቤኔዘር", "ዮናታን", "ኢያቡስቴ", "አቢሜሌክ"],
    correctAnswer: 1
  },
  {
    id: 8,
    text: "ዳዊት ከሳኦል ፊት ሸሽቶ ወደ ኖብ ከተማ በሄደ ጊዜ፥ ካህኑ አቢሜሌክ የሰጠው የትኛውን ሰይፍ ነበር?",
    options: ["የሳኦልን ሰይፍ", "የጎልያድን ሰይፍ", "የኢያሱን ሰይፍ", "የዮናታንን ሰይፍ"],
    correctAnswer: 1
  },
  {
    id: 9,
    text: "ዳዊት ሳኦልን በዋሻ ውስጥ እያለ መግደል ሲችል፥ ሳኦልን ሳይጎዳው ያደረገው ምልክት ምንድን ነበር?",
    options: ["የመጎናጸፊያውን ጫፍ ቆረጠ", "ጦሩንና የውኃ መያዣውን ወሰደ", "ሰይፉን ደበቀበት", "አክሊሉን ወሰደ"],
    correctAnswer: 0
  },
  {
    id: 10,
    text: "ዳዊት የዮናታን ልጅ የሆነውን እግሩ ሽባ የነበረውን ሰው ወደ ቤተ መንግሥቱ አምጥቶ በማዕዱ እንዲበላ ያደረገው ሰው ስም ማን ነው?",
    options: ["መፊቦስቴ", "ኢያቡስቴ", "አዶንያስ", "አሚናዳብ"],
    correctAnswer: 0
  },
  ];
