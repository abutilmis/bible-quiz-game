...
const questions: Question[] = [
  {
    id: 1,
    text: "በብሉይ ኪዳን ታሪክ መሠረት፣ እግዚአብሔር ለአብርሃም ልጁን ይስሐቅን መሥዋዕት አድርጎ እንዲያቀርብለት ያዘዘውና በኋላም የሰሎሞን ቤተ መቅደስ የተሠራበት ተራራ ወይም ምድር ምን ተብሎ ይጠራል?",
    options: ["የሲና ተራራ", "የሞሪያ ምድር", "የኮሬብ ተራራ", "የካርሜሎስ ተራራ"],
    correctAnswer: 1
  },
  {
    id: 2,
    text: "በሐዋርያት ሥራ መጽሐፍ መሠረት፣ የወንጌል አማኞች (ደቀ መዛሙርት) መጀመሪያ “ክርስቲያን” ተብለው የተጠሩት በየትኛው ታዋቂ ከተማ ነበር?",
    options: ["በኢየሩሳሌም", "በአንጾኪያ", "በቆሮንቶስ", "በሮሜ"],
    correctAnswer: 1
  },
  {
    id: 3,
    text: "ጌታችን ኢየሱስ ክርስቶስ ከመያዙ በፊት በከፍተኛ ጭንቀት የጸለየበትና ደቀ መዛሙርቱን ይዞ የመጨረሻውን ምሽት ያሳለፈበት ከደብረ ዘይት ተራራ ማዶ የሚገኘው ስፍራ  ማን ይባላል?",
    options: ["ጌቴሴማኒ", "ቀራንዮ", "ቤተ መቅደስ", "ቤተ ዓንያ"],
    correctAnswer: 0
  },
  {
    id: 4,
    text: "ነቢዩ ሙሴ የእግዚአብሔርን ሕግ (አሥርቱን ትእዛዛት) የተቀበለበትና እግዚአብሔር በ ደመናና በእሳት የወረደበት ተራራ የትኛው ነው?",
    options: ["የናባው ተራራ", "የታቦር ተራራ", "የሲና (ኮሬብ) ተራራ", "የአራራት ተራራ"],
    correctAnswer: 2
  },
  {
    id: 5,
    text: "በሉቃስ ወንጌል ምዕራፍ 24 መሠረት፣ ክርስቶስ ከትንሣኤው በኋላ ለሁለት ደቀ መዛሙርት መንገድ ላይ ተገልጦ መጻሕፍትን እየተረጎመ አብሯቸው የተጓዘው ወደ የትኛዋ መንደር ነበር?",
    options: ["ኤማሁስ", "ኢያሪኮ", "ቅፍርናሆም", "ጋዛ"],
    correctAnswer: 0
  },
  {
    id: 6,
    text: "በብሉይ ኪዳን ዘመን፣ ታቦት ወደ ኢየሩሳሌም ከመምጣቱ በፊት፣ ከእስራኤል ልጆች ጋር በምድረ በዳ ሲጓዝ የነበረው መገናኛው ድንኳን ለረጅም ዘመን ቆሞ የነበረበት  የትኛው ስፍራ ነበር?",
    options: ["ኬብሮን", "ሴሎ ", "ቤቴል", "ጊልጋል"],
    correctAnswer: 1
  },
  {
    id: 7,
    text: "ሐዋርያው ጳውሎስ በመቄዶንያ ራዕይ “ወደ መቄዶንያ ተሻገርና እርዳን” የሚል ጥሪ ከሰማ በኋላ፣ በአውሮፓ ምድር መጀመሪያ ወንጌልን የሰበከባትና ቤተ ክርስቲያን የመሠረተባት ከተማ ማን ናት?",
    options: ["ተሰሎንቄ", "ፊልጵስዩስ", "አቴና", "ቆሮንቶስ"],
    correctAnswer: 1
  },
  {
    id: 8,
    text: "በዘፍጥረት መጽሐፍ መሠረት፣ ታላቁ የኖኅ መርከብ ከማዕበሉና ከውኃው መጉደል በኋላ ያረፈችው በየትኛው ተራራ ላይ ነበር?",
    options: ["የአራራት ተራራ", "የሊባኖስ ተራራ", "የሄርሞን ተራራ", "የሰዓር ተራራ"],
    correctAnswer: 0
  },
  {
    id: 9,
    text: "ጌታችን ኢየሱስ ክርስቶስ የተሰቀለበትና በዕብራይስጥ “ጎልጎታ” ተብሎ የሚጠራው ቦታ የት ይገኛል?",
    options: ["በናዝሬት ከተማ አቅራቢያ", "ከኢየሩሳሌም ቅጥር ውጭ (ቀራንዮ)", "በዮርዳኖስ ማዶ", "በሰማርያ ተራራ ላይ"],
    correctAnswer: 1
  },
  {
    id: 10,
    text: "የእስራኤል ልጆች በምድረ በዳ ሲጓዙ ውኃ አጥተው በሙሴ ላይ ባጉረመረሙ ጊዜ፣ ሙሴ ዓለቱን መትቶ ውኃ ያፈለቀበት ስፍራዎች እነማን ናቸው?",
    options: ["ኤሊምና ሲና", "ማሳና መሪባ", "ቃዴስ በርኔና ሞዓብ", "ኬብሮንና ጌራል"],
    correctAnswer: 1
  }
];
      ...
      >
        <div className="bg-white/10 backdrop-blur rounded-2xl p-8 max-w-md w-full text-center border border-[#FFD966]/30 shadow-2xl">
          ...
          <div className="text-white/80 space-y-3 text-left mb-6">
            <p>✨ በዛሬው ውድድር <strong className="text-[#FFD966]">{10}የመጽሃፍ ቅዱስ የቦታ ጥያቄዎች</strong> ይኖሩናል።</p>
